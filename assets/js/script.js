...
const navBar = document.querySelector(".header"),
    ...
    testSliderWrapper = document.querySelector(".testimonials__wrapper"),
...
function changeHeaderBg() {
    ...
    if (scrollY > 100) {
        navBar.style.backgroundColor = "var(--blue-60-opacity-70)";
...
async function renderTestimonials() {
    ...
    data.map((testi) => {
        testSliderWrapper.innerHTML += Testimonial(testi);
    });
